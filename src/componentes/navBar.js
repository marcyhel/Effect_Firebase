            ...
            <aside id="closeDrawer" aria-label="Sidebar" aria-hidden="true" className={`${isOpen ? 'translate-x-0' : '-translate-x-full'} fixed top-0 left-0 z-40 w-56 h-screen pt-20 transition-transform -translate-x-full border-r sm:translate-x-0 bg-gray-800 border-gray-700`}>
                <div className="h-full px-3 pb-4 overflow-y-auto  bg-gray-800">
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link to="/list" className="flex items-center p-2  rounded-lg text-white  hover:bg-gray-700 group">
                        ...
                        {globalFirestoreData.role == "admin" ?
                            <li>
                                <Link to="/up-card" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-100  group">
                        ...
                        <li>
                            <Link to="/deck-communit" className="flex items-center p-2  rounded-lg text-white  hover:bg-gray-700 group">
                        ...
                        <li>
                            <Link to="/deck-list" className="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group">
